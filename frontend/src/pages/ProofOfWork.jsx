    ...
    return (
      <>
        <SEO
          ...
          description={`Watch the creative journey behind 5KSANA's crypto-inspired art. "Proof of Work" showcases the process of crafting unique paintings and embroidery pieces in a captivating video series.`}
